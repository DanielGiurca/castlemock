...
public class UpdateSoapProjectService extends AbstractSoapProjectService {

    public UpdateSoapProjectOutput process(UpdateSoapProjectInput input) {
        ...
        return UpdateSoapProjectOutput.builder()
