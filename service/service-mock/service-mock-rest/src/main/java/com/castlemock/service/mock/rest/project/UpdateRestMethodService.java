...
public class UpdateRestMethodService extends AbstractRestProjectService {

    public UpdateRestMethodOutput process(UpdateRestMethodInput input) {
        ...
        return UpdateRestMethodOutput.builder()
                .restMethod(updated)
                .build();
    }
}
