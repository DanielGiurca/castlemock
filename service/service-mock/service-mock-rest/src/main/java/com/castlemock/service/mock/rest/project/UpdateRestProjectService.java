...
public class UpdateRestProjectService extends AbstractRestProjectService {

    public UpdateRestProjectOutput process(UpdateRestProjectInput input) {
        ...
        return UpdateRestProjectOutput.builder()
